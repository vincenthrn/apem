...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
			...
			<?php
				...
				// Dropdown Input
					...
					?><div class="form-group">
						<select name="calc_shipping_state form-control" id="calc_shipping_state" placeholder="<?php _e( 'State / county', 'woocommerce' ); ?>">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', false ) ) : ?>
			...
			<div class="form-group">
				<input type="text" class="input-text form-controls" value="<?php echo esc_attr( WC()->customer->get_shipping_city() ); ?>" placeholder="<?php _e( 'City', 'woocommerce' ); ?>" name="calc_shipping_city" id="calc_shipping_city" />
			</div>
