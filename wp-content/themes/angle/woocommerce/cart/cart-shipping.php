...
<tr class="shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( 1 < count( $available_methods ) ) : ?>
			<ul class="list-unstyled" id="shipping_method">
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						<div class="radio">
							<?php
								printf( '
									<label for="shipping_method_%1$d_%2$s"><input type="radio" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d_%2$s" value="%3$s" class="shipping_method" %4$s />%5$s</label>',
