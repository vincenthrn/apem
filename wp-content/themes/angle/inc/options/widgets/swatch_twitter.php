...
class Swatch_twitter extends OxygennaWidget {
    ...
    */
    public function __construct() {
        $widget_options = array( 'description' => __( 'Displays you latest tweets', 'angle-admin-td') );
        parent::__construct( 'swatch_twitter-options.php', false, $name = THEME_NAME . ' - ' . __('Twitter Feed', 'angle-admin-td'), $widget_options );
    }
    ...
    function widget( $args, $instance ) {
        ...
        if ( empty( $account ) ) {
            if ( current_user_can('edit_theme_options') ) {
                ...
                echo '<p>' . sprintf( __( 'Please configure your Twitter username for the <a href="%s">Twitter Widget</a>.', 'angle-td' ), admin_url( 'widgets.php' ) ) . '</p>';
